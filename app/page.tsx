  ...
  return (
    <main className="relative min-h-screen bg-white flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-8 py-10">
        ...
        <div className="font-script text-5xl text-gold leading-tight">Hazim</div>
        <div className="font-serif text-xl text-gray-400 font-light my-1">&amp;</div>
        <div className="font-script text-5xl text-gold leading-tight">Idayu</div>
